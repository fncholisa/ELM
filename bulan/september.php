    ...
    <body>
        ...
        <div style="margin-left:10%;padding:80px 10px;">
            <div class="container">
                ...
                <div class="row">
                    <br><br><h1>DATA PENJUALAN - BULAN SEPTEMBER</h1>
                    
                    <form method="post" enctype="multipart/form-data" action="p_sept.php">
                        <button><input name="filehari" type="file" required="required"></button>
                        <button name="upload" type="submit">Import</button><br><br>
                        <?php
                        include "../koneksi.php";
                        $data = mysqli_query($koneksi, "SELECT * FROM september");
